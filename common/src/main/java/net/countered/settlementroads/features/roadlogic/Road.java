...
public class Road {
    ...
    public void generateRoad(int maxSteps){
        ...
        List<Records.RoadData> roadDataList = new ArrayList<>(WorldDataStorage.getRoadDataList(serverWorld));
        roadDataList.add(new Records.RoadData(width, type, material, roadSegmentPlacementList));

        WorldDataStorage.setRoadDataList(serverWorld, roadDataList);
